...
import { MudarPlanoAssinarAndroidPage } from '../mudar-plano-assinar-android/mudar-plano-assinar-android';

@Component({
  selector: 'page-mudar-planos-android',
  templateUrl: 'mudar-planos-android.html',
})
export class MudarPlanosAndroidPage {
  ...
  selecionarPlano(plano){
    ...
    */
    ...
    this.navCtrl.push(MudarPlanoAssinarAndroidPage);
