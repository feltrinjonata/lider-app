...
@Component({
  selector: 'page-mudar-plano-assinar',
  templateUrl: 'mudar-plano-assinar.html',
})
export class MudarPlanoAssinarPage {
  ...
  subscribeMembership( id ) {
    ...
    this.iap.getProducts([id]).then((product) => {
      ...
      this.iap.subscribe(id).then( (result)=> {
          ...
          console.log('passo 2', result.transactionId);
          ...
          buttons: [
            ...
            },              
            {
              ...
              handler: () => {
                ...
                setTimeout(() => {
                  this.navCtrl.push(MudarPlanoAssinarPage);
                }, 500);
